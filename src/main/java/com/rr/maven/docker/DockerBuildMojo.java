...
@Mojo(name = "packageContainer", defaultPhase = LifecyclePhase.INSTALL, threadSafe = true)
public class DockerBuildMojo extends AbstractDockerMojo {

  /**
   * Magic happens here for the packageContainer goal; basically it calls the buildContainer method which needs to be done after
   * we have generated the Dockerfile
   *
