...
public class DockerPublishMojo extends AbstractDockerMojo {
  ...
  /**
   * Actual method executed by maven does the push based on the config in the poms.
   *
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try {
      ...
      getLog().error("Error publishing container", e);
      throw new MojoExecutionException("Error pushing container", e);
    }
  }
}
